    ...
    var ut = function (t, e) {
        ...
        if (16 == a) {
            ...
            var tt = Math.round(20 * Math.random() - 10), et = Math.round(20 * Math.random() - 10),
                ot = Math.round(20 * Math.random() - 10), at = .4 * Math.random() - .2,
                it = .4 * Math.random() - .2, nt = 1 * Math.random() + 1, rt = 1 * Math.random() + 1,
                st = .3 * Math.random() + .3;
...
!function (e) {
    ...
    jQuery.extend(!0, A, {
        updateMarkup: function (e, t) {
            ...
            var t = e.caption, i = t.data(), a = e.label, n = e.timeline, r = e.frameindex, o = e.opt, s = t,
                d = {}, l = o.timelines[i._slideid].layers[i._id], m = i.frames.length - 1, c = i.frames[r].split,
            ...
            if (0 === r && !e.fromcurrentstate && void 0 !== i._bmask && void 0 !== g && 0 <= g.indexOf("block") || r === i.outframeindex && !e.fromcurrentstate && void 0 !== i._bmask && void 0 !== g && 0 <= g.indexOf("block")) {
                var T = 0 === r ? b.speed / 1e3 / 2 : _.speed / 1e3 / 2,
                    k = [{scaleY: 1, scaleX: 0, transformOrigin: "0% 50%"}, {
                        scaleY: 1,
                        scaleX: 1,
                        ease: _.anim.ease
        ...
        if ("column" === n._nctype && (punchgs.TweenLite.set(n._column, {
            ...
            if (e.css("-webkit-transition", "none"), e.css("-moz-transition", "none"), e.css("-ms-transition", "none"), e.css("transition", "none"), (void 0 !== e.data("transform_hover") || void 0 !== e.data("style_hover")) && punchgs.TweenLite.set(e, r.styleProps), punchgs.TweenLite.set(e, {
                ...
                var l = "slide" == r.basealign ? t.ulw : t.gridwidth[t.curWinRange],
                    ...
                    c = _(r.maxWidth, o, "none", l), p = _(r.maxHeight, s, "none", m),
                    g = _(r.minWidth, o, "0px", l), u = _(r.minHeight, s, "0px", m);
...
!function (a) {
    ...
    var e = function (a, b) {
        ...
        "vertical" === b.direction ? (h.css({
            ...
            width: h.outerWidth()
        })) : (h.css({left: (i - 1) * j + "px", top: "0px"}), e.css({
        ...
        u.find(j).css({backgroundImage: "url(" + e.thumbs[c.index()].src + ")"}), "vertical" === b.direction ? (u.css({
            ...
            width: u.outerWidth()
        })) : (u.css({left: (v - 1) * w + "px", top: "0px"}), p.css({
...
}(jQuery);var htmlDiv = document.getElementById("rs-plugin-settings-inline-css");
    var htmlDivCss = "";
    if (htmlDiv) {
