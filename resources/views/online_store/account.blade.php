                        ...
                        <div class="woocommerce">
                            <div class="woocommerce-form-login-toggle">
                                <div class="alert-danger">
                                    ...
                                    <div class="woocommerce-info">Change Your Profile</div>
                                    <form action="{{ url('customer/account') }}" class=" woocommerce-form-coupon register" method="post">
                                        @csrf
                                        <p class="form-row form-row-first">
                                            <input type="text" name="fullName" value="{{ $user->fullName }}" class="input-text" placeholder="Enter Fullname"/>
                                        </p>
                                        <p class="form-row form-row-first">
                                            <input type="text" name="email"  class="input-text" placeholder="Enter Email" value="{{ $user->email }}"/>
                                        </p>
                                        <p class="form-row form-row-first">
                                            <input type="text" name="mobile" class="input-text" placeholder="Enter Mobile" value="{{ $user->mobile }}"/>
                                        </p>
                                        <p class="form-row form-row-first">
                                        ...
                                        <p class="form-row form-row-first">
                                            Male : <input type="radio" name="gender"  value="Male"  @if($user->gender == 'Male') checked  @endif/>
                                            Female : <input type="radio" name="gender" value="Female" @if($user->gender == 'Female') checked  @endif/>
                                        </p>
