                                    ...
                                    <form action="{{ url('customer/login') }}" class="woocommerce-form woocommerce-form-login login" method="post"
                                        ...
                                        <p class="form-row">
                                            <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                                   value="1b38e699c6"/><input type="hidden" name="_wp_https_referer"
                                                                              value="/checkout/"/>
                                            <button type="submit" class="button" name="login" value="Login">Login</button>
                                            <input type="hidden" name="redirect"
                                                   value="https://sports-store.cmsmasters.net/checkout/"/>
                                        ...
                                        <p class="lost_password">
                                            <a href="https://sports-store.cmsmasters.net/my-account/lost-password/">Lost your
                                                password?</a>
                                        </p>
                                                ...
                                                <p class="form-row validate-required">
                                                    <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
                                                        ...
                                                        <span class="woocommerce-terms-and-conditions-checkbox-text">I have read and agree to the website <a
                                                                    href="https://sports-store.cmsmasters.net/terms-and-conditions/"
