...
<div class="gallery" id="gallery">
    <div class="container">
        <h3 class="title" style="font-family: 'Adobe Gothic Std';">Forma Athletes</h3>
                ...
                @foreach($athletes as $ath)
                    ...
                    @else
                        ...
                        <span class="image-block img-hover">
                              <figure>
                                 <img src="{{ 'http://adminhome.forma-eg.com/images/pt_images/'. $ath->img1  }}"
                                      class="img-responsive w3layouts agileits" alt="">
                                  <a href="{{ url('athlete/profile/'.$ath->id) }}">
                                 <figcaption>
                                    <h3>{{ $ath->trainer_name }}</h3>
                                 </figcaption>
                                  </a>
                              </figure>
                        </span>
