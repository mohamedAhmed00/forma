...
<head>
    ...
    <link href="{{ asset('css/save2.css') }}" rel="stylesheet">
...
<div id="main">
    ...
    <div id="middle">
        <h2 class="text-center">{{ substr($category->newscmscategoy,0,50) }}</h2>
                    ...
                    @foreach($category->SubCategory as $subcategory)
                        <div class="col-md-4">
                            <figure class="cmsmasters_img_wrap">
                                <a href="{{ url('newssubcategory/'.$subcategory->id) }}" class="cmsmasters_img_link">
                                    <img src="{{ url('https://adminhome.forma-eg.com/'.$subcategory->newscmsimage_sub)  }}"></a>
                            </figure>
